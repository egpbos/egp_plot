...
1. use the search functionality `here <https://github.com/egpbos/egp_plot/issues>`__ to see if someone already filed the same issue;
...
1. `push <http://rogerdudler.github.io/git-guide/>`_ your feature branch to (your fork of) the egp.plot repository on GitHub;
